...
<div class="container-fluid pt-2 pb-2">
		...
		<h3 class="page-title mb-0">수입/지출</h3>
			...
			<div class="card">
				<div class="card-body pt-3">
					...
					<div class="row mb-3">
						<div class="col-md-4">
							<label class="form-label">장부 선택</label>
					...
					<div class="row g-2 mb-3" id="searchArea" style="display:none;">
						...
						<div class="col-auto multi-select-dropdown">
							<button class="btn btn-outline-secondary btn-sm dropdown-toggle" type="button" id="bankDropdown" data-bs-toggle="dropdown" aria-expanded="false">
								계좌 전체
							</button>
						...
						<!-- 계정 (멀티 셀렉트) -->
						<div class="col-auto multi-select-dropdown">
							<button class="btn btn-outline-secondary btn-sm dropdown-toggle" type="button" id="accountDropdown" data-bs-toggle="dropdown" aria-expanded="false">
								계정 전체
							</button>
						...
						<!-- 기간검색 -->
						<div class="col-auto">
							<input type="text" id="searchDateRange" class="form-control form-control-sm" placeholder="기간 선택" style="width: 200px;">
						</div>
						<!-- 검색/초기화 버튼 -->
						<div class="col-auto">
	...
	<!-- 수입/지출 입력 Offcanvas -->
	<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEntry" aria-labelledby="offcanvasEntryLabel" style="width: 450px;">
