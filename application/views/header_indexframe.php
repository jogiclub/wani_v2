...
?>
	...
	<header class="py-3 border-bottom d-flex justify-content-center">
		...
		<div id="navbarKakao" class="kakao-channel d-flex justify-content-center align-items-center position-relative border border-warning" style="cursor: pointer; width: 40px; height: 40px; border-radius: 50%;" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="카카오채널">
