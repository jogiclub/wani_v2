...
<div class="container-fluid pt-2 pb-2">
	<nav class="mb-3" aria-label="breadcrumb">
		<ol class="breadcrumb mb-0">
			...
			<li class="breadcrumb-item active">메모관리</li>
		</ol>
	</nav>
...
<div class="offcanvas offcanvas-end" data-bs-scroll="true" data-bs-backdrop="true" tabindex="-1" id="memoOffcanvas" aria-labelledby="memoOffcanvasLabel" style="width: 500px;">
	<div class="offcanvas-header text-start">
		<h5 class="offcanvas-title" id="memoOffcanvasLabel">메모 일괄추가</h5>
		<button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
	</div>
	<div class="offcanvas-body">
		<form id="memoForm">
			<input type="hidden" id="memo_idx" name="idx">
			<input type="hidden" id="memo_mode" value="add">

			<div class="mb-3">
				<label for="memo_type" class="form-label">항목 <span class="text-danger">*</span></label>
			...
			<div class="mb-3">
				<label for="memo_date" class="form-label">날짜 <span class="text-danger">*</span></label>
				<input type="date" class="form-control" id="memo_date" name="memo_date" required>
			</div>
	...
	<div class="offcanvas-footer">
		<div class="d-flex gap-2 p-3 border-top bg-light">
			...
			<button type="button" class="btn btn-primary flex-fill" id="btnSaveMemo">저장</button>
		</div>
	</div>
</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="deleteModalLabel">메모 삭제</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				<p>선택한 메모를 삭제하시겠습니까?</p>
...
<script src="/assets/js/memos.js?<?php echo WB_VERSION; ?>"></script>
