...
class Detail_field_model extends CI_Model {
	...
	public function get_detail_fields_by_org($org_id) {
		$this->db->select('field_idx, field_name, field_type, field_size, field_position, display_order, is_active, field_settings, regi_date, modi_date');
	...
	public function get_detail_field_by_id($field_idx) {
		$this->db->select('field_idx, field_name, org_id, display_order, field_type, field_size, field_position, field_settings, is_active, regi_date, modi_date');
		$this->db->from('wb_detail_field');
