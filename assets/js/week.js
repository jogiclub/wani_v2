...
function updateMultipleMembers(formData, allGradeCheck, allAreaCheck) {
    ...
    $.ajax({
        url: '/week/update_multiple_members',
        method: 'POST',
        data: formData,
        processData: false,
        contentType: false,
...
function loadMemberAttendance(memberIdx, startDate, endDate) {
    $.ajax({
        url: '/week/get_member_attendance',
        method: 'POST',
        data: {
            member_idx: memberIdx,
            start_date: startDate,
...
function saveAttendance(memberIdx, attTypeIdx, attTypeCategoryIdx, selectedValue) {
    ...
    $.ajax({
        url: '/week/save_single_attendance',
        method: 'POST',
        data: {
            member_idx: memberIdx,
...
$(document).ready(function() {
    ...
    function loadLastWeekData(memberIdx, orgId, areaIdx, memberName) {
        ...
        $.ajax({
            url: '/week/get_last_week_attendance',
            method: 'POST',
            data: {
                member_idx: memberIdx,
                org_id: orgId,
